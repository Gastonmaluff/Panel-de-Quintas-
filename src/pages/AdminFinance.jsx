        ...
        <div className="admin-collapsible-card__content">
          ...
          <div className="admin-reservations-table-wrap">
            <table className="admin-reservations-table">
              ...
              <tbody>
                {finance.payments.map((payment) => (
                  <tr key={payment.id}><td>{payment.paymentDate}</td><td>{payment.clientName}</td><td>{payment.eventType}</td><td>{payment.method}</td><td className="money-column">{formatGuaranies(payment.amount)}</td><td><ReceiptAction item={payment} /></td></tr>
                ))}
              </tbody>
            </table>
          </div>
